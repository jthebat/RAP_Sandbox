CLASS zcl_fill_accounts_ti DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_fill_accounts_ti IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

  DATA: lt_accounts type table of ZACCOUNTS_TI.
...
DELETE FROM ZACCOUNTS_TI.

INSERT ZACCOUNTS_TI from table @lt_accounts.
